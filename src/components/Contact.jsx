    ...
    <section id="contact" className="relative overflow-hidden bg-[#F8F9FA] section-pad">
      <div ref={ref} className={`container-site relative z-10 ${revealClass}`}>
        ...
        <div className="mt-16 grid items-stretch gap-10 lg:grid-cols-2">
          <div className="group relative min-h-[520px] overflow-hidden rounded-2xl shadow-2xl ring-1 ring-gray-200/60 lg:min-h-[650px]">
            <img
              src={contactImg.src}
            ...
            <div className="relative z-10 flex h-full flex-col justify-between p-8 text-white sm:p-10">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div
                    key={label}
                    className="flex items-center gap-4 rounded-xl border border-white/10 bg-white/10 p-4 backdrop-blur-md transition hover:bg-white/20"
                  >
          ...
          <div className="rounded-2xl border border-gray-100 bg-white p-8 shadow-2xl sm:p-10">
