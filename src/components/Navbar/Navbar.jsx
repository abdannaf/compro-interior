...
export default function Navbar({ variant = 'transparent', currentPath = '/' }) {
      ...
      >
        ...
        >
          ...
          <div className="border-t border-white/10 p-6">
            <div className="mb-5 rounded-2xl border border-amber-400/20 bg-gradient-to-br from-amber-400/10 to-amber-400/5 p-5">
