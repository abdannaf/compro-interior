...
function StatItem({ icon, number, label, animate }) {
  ...
  return (
    <div className="group relative overflow-hidden rounded-3xl border border-gray-200 bg-white/90 p-5 backdrop-blur-xl transition-all duration-500 hover:-translate-y-2 hover:border-amber-400/30 hover:shadow-2xl hover:shadow-amber-100">
  ...
  return (
    <>
      <section ref={sectionRef} className="relative overflow-hidden bg-[#F8F9FA] section-pad">
        <div className="pointer-events-none absolute left-0 top-0 h-72 w-72 rounded-full bg-amber-400/10 blur-3xl" aria-hidden="true" />
        <div className="pointer-events-none absolute bottom-0 right-0 h-96 w-96 rounded-full bg-amber-100/40 blur-3xl" aria-hidden="true" />
        ...
        <div className="container-site relative flex flex-col items-center gap-16 lg:flex-row">
          ...
          <div ref={rightRef} className={`relative w-full lg:w-1/2 ${rightReveal}`}>
            <div className="group relative overflow-hidden rounded-[2rem] shadow-2xl ring-1 ring-gray-200/60">
              <img
                src={achieveImg.src}
              ...
              <div className="absolute bottom-6 left-6 right-6 rounded-3xl border border-white/10 bg-white/10 p-5 text-white backdrop-blur-xl">
            ...
            <div className="absolute -bottom-8 -right-8 hidden rounded-3xl border border-gray-100 bg-white px-8 py-6 shadow-2xl md:block">
