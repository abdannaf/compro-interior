...
function BlogCard({ blog, imageSrc }) {
  ...
  return (
    <article className="group flex h-full flex-col overflow-hidden rounded-3xl border border-gray-100 bg-white shadow-lg transition-all duration-500 hover:-translate-y-2 hover:border-amber-200/60 hover:shadow-2xl">
...
export default function BlogsPreview() {
  ...
  return (
    <section className="relative overflow-hidden bg-[#F8F9FA] section-pad">
      <div
        className="pointer-events-none absolute right-0 top-0 h-80 w-80 rounded-full bg-amber-200/25 blur-3xl"
        aria-hidden="true"
      />
      ...
      <div ref={ref} className={`container-site relative z-10 ${revealClass}`}>
        <PreviewSectionHeader
          ...
          highlight="insights"
          description="Trends, inspiration, and practical tips from our interior specialists — written for homeowners and businesses."
          ctaHref="/blog"
