...
export default function Hero() {
  return (
    <section className="relative min-h-screen overflow-hidden bg-gray-950 text-white">
      ...
      <div className="pointer-events-none absolute -right-24 top-1/4 h-96 w-96 rounded-full bg-amber-400/10 blur-3xl" />
      ...
      <div className="relative z-10 flex min-h-screen items-center container-site pb-24 pt-28">
        <div className="max-w-5xl">
          ...
          <div className="hero-enter hero-enter-delay-4 mt-10 flex flex-col gap-3 sm:flex-row">
            ...
            <a
              href="/#contact"
              className="group inline-flex items-center justify-center gap-2 rounded-2xl border border-white/20 bg-white/10 px-7 py-4 font-medium text-white backdrop-blur-md transition duration-300 hover:-translate-y-0.5 hover:border-white/40 hover:bg-white hover:text-gray-950 active:translate-y-0"
            >
              Start Consultation
      ...
      >
        ...
        <span className="animate-bounce-soft flex h-10 w-10 items-center justify-center rounded-2xl border border-white/20 bg-white/10 backdrop-blur-md">
