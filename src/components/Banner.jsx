    ...
    <section className="font-poppins relative overflow-hidden bg-gray-950 text-white section-pad">
      ...
      <div className="container-site relative z-10 flex flex-col gap-10 lg:flex-row lg:items-end lg:justify-between">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:shrink-0">
          <a
            href="/projects"
            className="group inline-flex items-center justify-center gap-2 rounded-xl border border-white/20 bg-white/10 px-6 py-3.5 text-sm font-semibold backdrop-blur-md transition duration-300 hover:-translate-y-0.5 hover:bg-white hover:text-gray-950"
          >
            View Projects
