...
function ServiceCard({ service, isActive, onActivate }) {
  return (
    <article
      ...
      onFocus={onActivate}
      className={`group flex h-full flex-col overflow-hidden rounded-2xl border bg-white transition-all duration-500 ${
        isActive
    ...
    <section className="relative overflow-hidden bg-[#F8F9FA] section-pad">
      <div ref={ref} className={`container-site relative z-10 ${revealClass}`}>
        <PreviewSectionHeader
          ...
          description="Creativity, function, and craftsmanship for homes, offices, and commercial spaces."
          ctaHref="/services"
