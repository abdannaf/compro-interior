...
function EmptyProjects() {
  return (
    <div className="rounded-2xl border border-dashed border-gray-200 bg-[#F8F9FA] px-8 py-16 text-center">
...
function ProjectCard({ project, imageSrc }) {
  ...
  return (
    <a
      ...
      className="group relative block overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-xl ring-1 ring-gray-100/80 transition-all duration-500 hover:-translate-y-2 hover:border-amber-200/50 hover:shadow-2xl"
    >
