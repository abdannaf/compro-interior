...
function StatCard({
  ...
  return (
    <div className="group relative overflow-hidden rounded-2xl border border-gray-100 bg-white/80 backdrop-blur-xl p-5 transition-all duration-500 hover:-translate-y-1 hover:border-amber-200 hover:shadow-xl hover:shadow-amber-100/40">
    ...
    >
      ...
      >
        ...
        <div className="relative">
          ...
          {/* Main image */}
          <div className="group relative overflow-hidden rounded-2xl bg-gray-200 shadow-[0_25px_80px_rgba(0,0,0,0.12)]">
            {!imgLoaded && !imgError && (
              <div
            ...
            <div className="absolute bottom-6 left-6 right-6">
              <div className="rounded-2xl border border-white/10 bg-white/10 p-5 backdrop-blur-2xl">
        ...
        <div className="flex flex-col">
          ...
          <div className="mt-12 flex flex-col gap-4">
            {features.map((feature, idx) => (
              <div
                key={idx}
                className="group flex items-start gap-4 rounded-2xl border border-transparent bg-white p-5 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-amber-100 hover:shadow-xl hover:shadow-amber-100/30"
              >
          ...
          <div className="mt-12 flex flex-wrap gap-4">
            <a
              href="/services"
              className="group inline-flex items-center gap-2 rounded-xl bg-gray-900 px-7 py-4 text-sm font-medium text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-amber-400 hover:text-black hover:shadow-xl hover:shadow-amber-200/40"
            >
              Explore Services
            ...
            <a
              href="/#contact"
              className="group inline-flex items-center gap-2 rounded-xl border border-gray-200 bg-white px-7 py-4 text-sm font-medium text-gray-700 transition-all duration-300 hover:-translate-y-0.5 hover:border-amber-200 hover:bg-amber-50 hover:text-amber-500"
            >
              Contact Us
